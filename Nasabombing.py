...
def bann_text():
    ...
    logo = """
   _   _                 ____                  _     _            
| \ | | __ _ ___  __ _| __ )  ___  _ __ ___ | |__ (_)_ __   __ _
|  \| |/ _` / __|/ _` |  _ \ / _ \| '_ ` _ \| '_ \| | '_ \ / _` |
| |\  | (_| \__ \ (_| | |_) | (_) | | | | | | |_) | | | | | (_| |
|_| \_|\__,_|___/\__,_|____/ \___/|_| |_| |_|_.__/|_|_| |_|\__, |
                                                           |___/
                                         """
    if ASCII_MODE:
        logo = ""
...
def format_phone(num):
    ...
    return ''.join(num).strip()
        ...
        dir_name = "Nasabombing_gh"
    else:
        zip_url = "https://github.com/NasaHogar/Bombing/tree/main/archive/master.zip"
        dir_name = "Nasabombing-master"
    ...
    if success:
        ...
        mesgdcrt.FailureMessage("Unable to update Nasabombing.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/NasaHogar/Bombing. git")
...
def do_git_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("Nasabombing was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update Nasabombing.")
        ...
        print(
            "git checkout . && "
            "https://github.com/NasaHogar/Bombing.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/NasaHogar/Bombing master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/NasaHogar/Bombing/raw/dev/.notify"
        else:
            url = "https://github.com/NasaHogar/Bombing/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Nasabombing was created by NasaHogar")
...
description = """NasaBombing - Your Friendly Spammer Application

Nasabombing can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

Nasabombing is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by NasaHogar !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start NasaBombing with SMS Bombing mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start Nasabombing with CALL Bombing  mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start Nasabombing with MAIL Bombing mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update Nasabombing")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current Nasabombing contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current Nasabombing version")
